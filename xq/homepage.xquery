                ...
                <div
                    ...
                    <div
                        ...
                        <p>The majority of glosses are written by a single hand, except for rare later addictions;
                            They are divided in three types:</p><ol><li> interlinear glosses, used to to clarify the classical Latin;</li>
                            <li> marginal glosses, used to explain the main text, i.e. meaning of single words, sentences and events mentioned in;
                                they are anchored to the main text by a set of marks (mostly Greek alphabet).</li>
                            <li> additional glosses written in red capital letters,
                                wich refers to the rethorical aspects.</li></ol>
                        <h5>The BGS'Project aims:</h5>
                        <ol><li>to give a direct access to the text based on interpretative transcription (i. e. restitution of capital letters, distinction between <i>u</i> / <i>v</i>, modern words' segmentation) in a easy way, also for the readers not used to the Latin paleography</li>
                            <li>to offer the possibility to compare the original layout and the modern transcription;</li>
                            <li>to give the text transcription of all type of glosses and to show easily and directly their purpose;</li>
                            <li>to explain the correct order of the marginal glosses;</li>
                            <li>to offer lexical concordances of the entire text and a direct link to a dictionary i. e. Logeion.</li></ol>
                        <h5>HOW TO NAVIGATE:</h5>
                        <ol><li>on the left side of the page you will find the zoomable image of manuscript; on the centre the interpretative transcription of the main text;</li>
                            <li>if you want to read the interlinear glosses: move your mouse on the underlined words, they will appear as a pop-up above the text;</li>
                            <li>if you want to read the marginal and additional glosses move your mouse on the the highlighted words, they are in the right side of the page;</li>
                            <li>if you want to search a single word in the text: write it in the "search box"; you can select the criteria of research "main text", "interlinear glosses", "marginal glosses" (in wich are included the additional ones) or combining them. The concordances will appear in a second page surrounded by context, references to the passages and direct link to the text that they belong.</li></ol>
    ...
    <div class="row py-2">
        <div class="col-4 bg-light" id="ms-image-container">
            ...
            <figure>
                <img class="ms-image" data-scale="1" src="Photos/kk.3.21-6r.jpg"
                    alt="image of the manuscript"></img>
        ...
        <div class="col-5">
            ...
            <div id="transcription">
                ...
                praepositum domus. <a class="glossed" data-glossed-by="interlinear"
                    ...
                    data-content="ab inchoato malo">ab incoepta</a> per <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="imo non solum coeperat sed imo perpetraverat"
                    > perpetrataque</a> iam prorsus <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
                    data-content="iniustitia">iniuria</a> deieci. Quotiens <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="nostros">miseros</a> quos infinitis calumniis
                    <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top"
                    data-content="quia inpune remanebat id est sine victoria">inpunita</a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="id est gothorum"><span
                        class="glossed" data-glossed-by="marginalia" data-marginalia-id="1"> B
                        barbarorum</span></a> semper avaritia vexabat; <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top"
                    data-content="opposita. aversita ab defensione mea. consulari quererat consul"
                    >obiecta</a> periculis auctoritate protexi. Num quam me <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="id est a iustitia">ab iure</a>. <a
                ...
                detraxit. <a class="glossed" data-glossed-by="marginalia" data-marginalia-id="2">A
                    Provincialium</a> fortunas. <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
                    data-content="primum patrones ministrosque">tum </a> privatis rapinis. <a
                    class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="aliquando">tum </a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="dominicis">publicis </a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="de teleonis id est cum"
                    >vectigalibus </a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top"
                    data-content="id est periclitari perire id est in perditionem reditibus que a rege invehebantur"
                        ><span class="glossed" data-glossed-by="marginalia" data-marginalia-id="3">
                        G pessumdari</span></a> ; non aliter quam qui patiebantur <a class="glossed"
                    data-glossed-by="marginalia" data-marginalia-id="4">F indolui. </a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top"
                    data-content="id est amare et in maturar et est metafora ab uvis immaturis"> Cum
                    acerbae famis tempore. gravis </a> atque inexplicabilis <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="a rege constituta"><span class="glossed"
                        data-glossed-by="marginalia" data-marginalia-id="5"> N indicta</span></a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="qua milites alerent"
                        ><span class="glossed" data-glossed-by="marginalia" data-marginalia-id="6">
                        E coemptio</span></a>. <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
                    data-content="afflictura">pro fligatura</a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="per inopiam">inopia</a>
                campaniam provinciam videretur; certamen adversum <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                ...
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    ...
                    >pramtorii communis </a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="utilitatis">commodi
                </a>ratione suscepi; <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
                ...
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    ...
                    data-marginalia-id="7"><span class="glossed" data-glossed-by="interlinear"
                        data-trigger="focus" data-toggle="popover" data-placement="top"
                        data-content="tributum">Et ne coemptio exigeretur D evici.</span></a>
                ...
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    ...
                    data-content="dignum consulatum de consulato depositus iniusta accusatione barbari in palatio ne fiducia"
                        ><span class="glossed" data-glossed-by="marginalia" data-marginalia-id="9">
                        O consularem virum. </span></a> cuius <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="facultates">opes </a>
                ...
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="id est canini homines"
                        ><span class="glossed" data-glossed-by="marginalia" data-marginalia-id="11">
                        H canes</span></a> iam spe atque <a class="glossed"
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="superbia">ambitione</a>
                <a class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="prodevorant"
                    ...
                    data-glossed-by="interlinear" data-trigger="focus" data-toggle="popover"
                    data-placement="top" data-content="quare">Ne </a>
                <a class="glossed" data-glossed-by="marginalia" data-marginalia-id="12">R
                    Albinum.</a> consula rem virum. <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
                    data-content="prepropere male iudicate indiscusse">praeiudicatae </a>
                <a class="glossed" data-glossed-by="marginalia" data-marginalia-id="13">P
                    accusationis</a> poena <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
                    data-content="scilicet ut moriretur">corriperet</a>; odiis me cypriani <a
                    class="glossed" data-glossed-by="interlinear" data-trigger="focus"
                    data-toggle="popover" data-placement="top" data-content="accusatoris inmisi"
                    >delatoris</a> opposui. Satisne <a class="glossed" data-glossed-by="interlinear"
                    data-trigger="focus" data-toggle="popover" data-placement="top"
        ...
        <aside class="col-3" id="marginalia">
            ...
            <div class="pre-scrollable">
                ...
                <div class="marginalia" data-marginalia-id="2">Provinciales sunt milites qui a
                    militia liberi sunt. Et nulli quicquam debent. Idem prolitteri dicti quod soli
                    prole faveant; </div>
                <div class="marginalia" data-marginalia-id="3">Pessum dari quasi pedes sursum dare
                ...
                <div class="marginalia" data-marginalia-id="10">Palatinos viros qui assiduae
