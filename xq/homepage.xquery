                    ...
                    class="row py-2"><div
                        ...
                        id="ms-image-container"><div
                            ...
                            aria-label="Basic example"><button
                                ...
                                class="btn btn-secondary"
                                data-action="zoom-image"
                                data-direction="out">-</button></div><img
                            class="ms-image"
                            data-scale="1"
                            src="Photos/kk.3.21-7r.jpg"
                            alt="image of the manuscript">kk.3.21-7r</img></div><div
                        class="col-5"><div
                            class="row"><h1
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="regali">regiae</a> praepositum
                            domus.
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="imo non solum coeperat sed imo perpetraverat">
                                perpetrataque</a> iam prorsus <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                                data-toggle="popover"
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="id est gothorum"><span
                                    class="glossed"
                                    data-glossed-by="marginalia"
                                    data-marginalia-id="1">
                                    
                                    B barbarorum
                                </span></a> semper avaritia vexabat;
                            <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                                data-toggle="popover"
                                data-placement="top"
                                data-content="opposita. aversita ab defensione mea. consulari quererat consul">obiecta</a> periculis auctoritate protexi.
                            Num quam me <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                                data-toggle="popover"
                                data-placement="top"
                                data-content="id est a iustitia">ab iure</a>. <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                                data-toggle="popover"
                                data-placement="top"
                                data-content="ad iniustitiam">ad iniuriam </a>
                            <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                            ...
                            <a
                                class="glossed"
                                data-glossed-by="marginalia"
                                data-marginalia-id="2">
                                A Provincialium</a> fortunas. <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                                data-toggle="popover"
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="de teleonis id est cum">vectigalibus </a>
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="id est periclitari perire id est in perditionem reditibus que a rege invehebantur"><span
                                    class="glossed"
                                    data-glossed-by="marginalia"
                                    data-marginalia-id="3">
                                    
                                    G pessumdari
                                </span></a> ; non aliter quam qui patiebantur
                            <a
                                class="glossed"
                                data-glossed-by="marginalia"
                                data-marginalia-id="4">
                                F indolui. </a>
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="domus iudicatoriae">pramtorii communis </a>
                            <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                            ...
                            <a
                                ...
                                data-toggle="popover"
                                data-placement="top"
                                data-content="prodevorant">devorassent </a> ; ab ipsis
                            <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                            ...
                            <a
                                class="glossed"
                                data-glossed-by="marginalia"
                                data-marginalia-id="12">
                                R Albinum.</a> consula rem virum. <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                                data-toggle="popover"
                            ...
                            <a
                                class="glossed"
                                data-glossed-by="marginalia"
                                data-marginalia-id="13">
                                P accusationis</a> poena
                            <a
                                class="glossed"
                                data-glossed-by="interlinear"
                                data-trigger="focus"
                        ...
                        id="marginalia"><h2>Marginalia</h2><div
                            class="pre-scrollable"><div
                                ...
                                class="marginalia"
                                data-marginalia-id="2">Provinciales sunt milites qui a militia liberi sunt. Et nulli quicquam debent. Idem prolitteri dicti quod soli prole faveant; </div><div
                                class="marginalia"
                                data-marginalia-id="3">Pessum dari quasi pedes sursum dare dum aliquis retro cadit; </div><div
                                class="marginalia"
                                data-marginalia-id="4">Quia insolita tributa pendebant aliquando iubente rege gothorum. aliquando eo nesciente. ideo dolebat iste sicut illi quae patiebantur; </div><div
                                class="marginalia"
                                ...
                                class="marginalia"
                                data-marginalia-id="10">Palatinos viros qui assiduae palatium incolunt . Palatines canes vocat propter cupiditatem voracitatis; </div><div
                                class="marginalia"
                                ...
                                class="marginalia"
                                data-marginalia-id="13">Quia antequam praesentaretur ut se defenderet regit potestas iussit eum puniri; </div></div></aside></div></div>
